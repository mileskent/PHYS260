...
% From here on I just use my notes
% Note to go back and add stuff from tb
...
% 25
    ...
    \section{Resistivity}	
        ...
        \begin{figure}[H]
            \includegraphics[width=\linewidth]{resistivities} % Figure image
            \caption{Resistivities at $20^{\circ}$C} % Figure caption
        \end{figure}
%        Resitivity has the following relationship with tempurature. However, it is probably not going to be tested on.
%        $$\rho(T) = \rho_0 (1 + \alpha(T-T_0))$$
    ...
    \section{Circuits and EMF}	
        ...
        \begin{figure}[H]
            \includegraphics[width=0.35\textwidth]{25-11-A} % Figure image
        \end{figure}

        \begin{figure}[H]
            \includegraphics[width=0.35\textwidth]{25-11-B} % Figure image
        \end{figure}

        \begin{figure}[H]
            \includegraphics[width=0.9\linewidth]{25-11-C} % Figure image
        \end{figure}
...
% 26
    ...
    \section{Kirchhoff's Rules}
        \subsection{Junction Rule}
            $$\Sigma I = 0$$
            \begin{figure}[H]
                \includegraphics[width=0.5\linewidth]{junctionrule} % Figure image
                \caption{Current that goes into a junction must leave the junction}
            \end{figure}
        \subsection{Loop Rule}
            $$\Sigma \Delta V = 0$$
            \begin{figure}[H]
                \includegraphics[width=0.5\linewidth]{looprule} % Figure image
    ...
    \section{R-C Circuits}
        ...
        \begin{figure}[H]
            \includegraphics[width=0.5\linewidth]{RC} % Figure image
